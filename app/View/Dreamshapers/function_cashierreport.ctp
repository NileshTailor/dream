<table class="table table-striped table-bordered table-hover" style="margin-top:1px" id="sample_1">
	<thead>
    <tr style="background-color:#FFF"><td colspan="5" align="center"><p><div><b><font size="+3">Cashier Report(Function)</font></b></div></p></td></tr>
    ...
    <tr>
     ...
     $total=0;
     $i=0;
		 foreach($fetch_receipt_checkouut as $data){ 
		 $i++;
