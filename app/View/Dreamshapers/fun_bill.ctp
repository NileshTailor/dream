...
<div id="message"></div>
  <div ng-spinner-bar="" class="page-spinner-bar hide">
		...
		<div class="bounce3"></div>Function Bill
	</div>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tabbable tabbable-custom tabbable-border">
            <ul class="nav nav-tabs">
                <li <?php if(empty($active) || $active==1){?> class="active"<?php } else {?>class=""<?php }?>  >
                    <a aria-expanded="true" href="#tab_1_1" data-toggle="tab">Function Bill
</a>
                </li>
				...
				?>
                    ...
                    <form method="post" name="add" id="receiptadd_id">
                        ...
                        <td colspan="8">
                           <fieldset>
                                        <legend>
                                        <span style="color:#4DB3A2 !important" class="caption-subject font-green-sharp bold"><h5><strong>Function Booking Wise Receipt</strong></h5></span>
                                        </legend>
                           <table width="100%">
                        <tr>
                                         
                                         <td width="12%"><label>Select Bill No.</label></td>
                        <td width="15%" align="left"><select class="form-control input-small select2me" style="width:90px;" name="bill_no_id" id="bill_no_id" placeholder="select..." onChange="payble_fun();">
                        ...
                        <option value="<?php echo $data['function_booking']['id'];?>"><?php echo $data['function_booking']['id'];?> (<?php echo $data['function_booking']['name'];?>) 
                           ...
                           ?>   
                            ...
                            <td style="padding-left:10px"><label>Reservation No.</label></td> <td align="left"><input type="text" class="form-control input-inline input-small" readonly="readonly" id="res_id" name="res_no_id" ></td>
                            <td><label></label></td><td><label></label></td></tr>
                                       <tr>
                                       <td style="padding-left:10px"><label>Total</label></td> 
                            <td><input type="text" class="form-control input-inline input-small" placeholder="Total" name="pax_amt" id="t_id"></td>
                            
                            <td><label>Advance</label></td> 
                            <td><input type="text" class="form-control input-inline input-small" placeholder="Paid" name="advance" id="paid_id"></td>
...
<table width="50%" border="0" align="">
 ...
 <div <?php if($active=='3'){?> class="tab-pane fade active in"<?php } else {?>class="tab-pane fade"<?php } ?> id="tab_1_3">
                <?php if(empty($ftch_receipt_checkout))
                {?>
  ...
  <table class="table table-bordered table-hover" id="sample_1" width="100%">
    ...
    <th>S. No.</th>
     ...
     <tbody>
     	<?php
		$i=0;
		 foreach($ftch_receipt_checkout as $data){ 
		 $i++;
...
function payble_fun()
	{
		var id=$("select[name=bill_no_id]").val();
			...
			$.ajax({
				url: "ajax_php_file?function_bill_set=1&q="+id,
				type: "POST",         
