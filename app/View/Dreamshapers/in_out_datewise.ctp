   <div class="table-responsive">
                        <div class="portlet box" style="border:#FFF !important; background-color:#E26A6A">
                            <div class="portlet-title box white">
                                <div class="caption">
                                    <i class="fa fa-book" style="color:#FFF"></i><strong>Inward/Outward Report</strong>
                                </div>
                            </div>
                            ...
                            <input type="radio" name="cash_report" value="0"  id="room_service2" checked="checked">Inward Report</label>
                                <label class="radio-inline">		
                               <input type="radio" name="cash_report" value="1"  id="room_service1">Outward Report</label>
                              <!-- <label class="radio-inline">		
                               <input type="radio" name="cash_report" value="2"  id="room_service1">Available Inventory Report</label>-->
                                </div>
                                </td>
                               ...
                               <td><label style="margin-right:100px;"><button type="submit1" name="submit1" class="btn red btn-sm"><i class="fa fa-print"></i> Report</button></label></td>
