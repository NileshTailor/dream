...
<div id="toasthide">
<div role="alert" aria-live="polite" class="toast-top-right" id="toast-container" style="display:none; padding-top:40px"><div style="" class="toast " id="hide"><button role="button" class="toast-close-button">×</button><div class="toast-title">Outward (Item)</div><div class="toast-message"> </div></div></div>
</div>
<div class="row"> 
    <div class="col-md-12">
        <div class="tabbable tabbable-custom tabbable-border">
            <ul class="nav nav-tabs">
               <li <?php if(empty($active) || $active==1){?> class="active"<?php } else {?>class=""<?php }?>  >
                    <a aria-expanded="true" href="#tab_1_1" data-toggle="tab">Outward
                    </a>
                </li>
            ...
            <div class="tab-content">
             <div <?php if(empty($active) || $active=='1'){?> class="tab-pane fade active in"<?php } else {?>class="tab-pane fade"<?php }?>  id="tab_1_1">
                ...
                if(!empty($error))
				{
					echo "<div id='success' class='note note-danger alert-notification'><p>Sorry, You Can not Issue, Data Out of Range</p></div>";
					
				}
				?>
                    <form method="post" name="add" id="add_outward">
...
<input type="text" class="form-control input-inline input-small date-picker" data-date-format="dd-mm-yyyy" placeholder="DD-MM-YYYY" name="date" id="date" data-date="00-00-0000"  value="<?php echo date("d-m-Y"); ?>">                            </td></tr>
                        ...
                        <tr>
                        <td colspan="2"><center><button type="submit" name="add_outward" class="btn green" value="add_outward"><i class="fa fa-plus"></i> Add</button>
                        
<button type="reset" name="" class="btn red " value="add_outward"><i class="fa fa-level-down"></i> Reset</button></center></td>
                        </tr>
                        </table>
                     </div>
                    </form>
        ...
        <tr>
                        ...
                        <tr>
                         ...
                         <tr><td colspan="3"><center><div class="modal-footer">
											...
											<button type="submit" name="edit_outward" value="edit_outward" class="btn blue">Update</button>
										</div></center></td></tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn default" data-dismiss="modal">Close</button>
                    <button type="button" onclick="Masteritem_category();" data-dismiss="modal" class="btn green" value="add_outward"><i class="fa fa-plus"></i> Add</button>						
                </div>
          </div>
      </div>
  </div>
