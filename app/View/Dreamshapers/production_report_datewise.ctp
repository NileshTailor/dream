   <div class="table-responsive">
                        ...
                        <div class="portlet box" style="border:#FFF !important; background-color:#E26A6A">
                            <div class="portlet-title box white">
                                <div class="caption">
                                    <i class="fa fa-book" style="color:#FFF"></i><strong>Production Report</strong>
                                </div>
                            </div>
                               ...
                               <td><label style="margin-left:10px;"><button type="submit1" name="submit1" class="btn red btn-sm"><i class="fa fa-print"></i> Report</button></label></td>
