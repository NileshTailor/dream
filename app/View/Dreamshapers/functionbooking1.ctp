...
<div class="row">
    <div class="col-md-12">
        <div class="tabbable tabbable-custom tabbable-border">
            ...
            <ul class="nav nav-tabs print-hide">
                <li <?php if(empty($active) || $active==1){?> class="active"<?php } else {?>class=""<?php }?>  >
                    ...
                    <span style="color:#4DB3A2 !important" class="caption-subject font-green-sharp bold uppercase"><h6><strong>Function Booking</strong></h6></span>
                    </a>
                </li>
                <li <?php if($active=='2'){?> class="active"<?php } else {?>class=""<?php }?>>
                    <a aria-expanded="false" href="#tab_1_4" data-toggle="tab">
                ...
                <div id="tab_1_1" <?php if(empty($active) || $active==1){?> class="tab-pane fade active in"<?php } else {?>class="tab-pane fade"<?php }?> >
                    <form method="post" id="add_function_booking">
                        ...
                        <td><label>Address</label></td>
                         <td colspan="7"><input type="text" name="address" class="form-control input-inline" style="width:100%" /></td></tr>
                        ...
                        <td><input type="text"  class="form-control input-inline input-small" name="pax_r" id="pax_r" onkeyup="calc();"></td>
                                </tr>
                        ...
                        <td><input type="text" class="form-control input-inline input-small" onkeyup="pax_chk()" placeholder="PAX" name="pax" id="pax" ></td>
                        <td><label>PAX Expected</label></td>
                        <td><input type="text" class="form-control input-inline input-small" placeholder="PAX Expected" name="per_expected" id="pax_expected" ></td>
                       
                        </tr>
                        <tr>
                         <td><label>Advance</label></td>
                        <td align="left"><input type="text" class="form-control input-inline input-small" placeholder="Advance" name="advance" id="advance"></td>
                        <td align="right"><label>Tax&nbsp;(%)</label></td>
                        <td><input type="text" disabled="disabled" class="form-control input-inline input-small" placeholder="Tax" name="tax_id" id="tax_id"></td>
                        <td><label>Rate Per Person</label></td>
                        <td><input type="text" class="form-control input-inline input-small" placeholder="PAX Amount" name="pax_amt" id="pax_amt" onkeyup="outlet_rate();" ></td>
                        <td><label>Approx Amount</label></td>
                        <td><input type="text" class="form-control input-inline input-small" placeholder="Total" name="tot_amt" id="tot_amt" ></td>
                        </tr>
                        <tr style="background-color:#D0CFF8">
                        <td colspan="8" align="left" style="font:Georgia, 'Times New Roman', Times, serif:"><font color="#000"><i class=" icon-magnet"></i> Conference Arrangement</font></td></tr>       
                        <tr>
                        <td><label>No. of Person</label></td>
                        <td colspan="7"><input type="text" class="form-control input-inline input-small" placeholder="No. of Persons" name="no_of_person" ></td></tr>
                        ...
                        <tr style="background-color:#D0CFF8">
                        <td colspan="7" style="font:Georgia, 'Times New Roman', Times, serif:"><font color="#000"><i class="icon-basket"></i>Other Services </font></td>
                     ...
                     <tbody>
                        ...
                        <tr style="background-color:#D0CFF8">
                        <td colspan="7" style="font:Georgia, 'Times New Roman', Times, serif:"><font color="#000"><i class="icon-emoticon-smile"></i> Menu Choices</font></td>
        ...
        <tr>
        <td colspan="10"><center><button type="submit" name="add_function_booking" class="btn green" value="add_function_booking"><i class="fa fa-plus"></i> Add</button></center></td>
        </tr>
                </table>
                    </form>
