   <div class="table-responsive">
                        ...
                        <div class="portlet box" style="border:#FFF !important; background-color:#E26A6A">
                            <div class="portlet-title box white">
                                <div class="caption">
                                    <i class="fa fa-book" style="color:#FFF"></i><strong>Cover Statement Report</strong>
                                </div>
                            </div>
                               ...
                               <td><label style="margin-left:10px;"><button type="submit" name="submit" class="btn red btn-sm" target="_blank"><i class="fa fa-print"></i> Report</button></label></td>
