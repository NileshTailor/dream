                ...
                <div class="tab-pane fade active in" id="tab_1_1">
                    <form method="post" name="add">
                        ...
                        <tr>
                                            ...
                                            <td><select class=" form-control input-small" name="room_reservation_id">
                        ...
                        <tr>
                                           ...
                                           <td><select class=" form-control input-small" name="company_id" onchange="room_rate()">
                                            <option value="">--Select --</option>
                                            <?php
                                            ...
                                            <td><input type="text" class="form-control input-inline input-small" placeholder="Guest Name" name="guest_name" ></td>
                                          ...
                                          <td><label>City</label></td> 
                                           ...
                                           <td><label>Nationality</label></td> 
                                            <td><input type="text" class="form-control input-inline input-small" placeholder="Nationality" name="nationality" ></td>
       ...
       $guest_name=$data['room_checkin_checkout']['guest_name'];
        ...
        <td>									<a class="btn default btn-xs blue-stripe" data-toggle="modal" href="#popup_<?php echo $id_room_checkin_checkout; ?>"> Edit </a>
                        ...
                        <input type="hidden" name="checkin_id" value="<?php echo $id_room_checkin_checkout; ?>" id="edit_checkin_id" />
                                            ...
                                            <td><select class=" form-control input-small" name="edit_room_reservation_id" 
                                            value="<?php echo $data['room_checkin_checkout']['room_reservation_id']; ?>">
                                            <option value="">--Select --</option>
                                            <?php
